      ...
      <main className="mt-16">
        ...
        <AboutSection
          ...
          description={[
            ...
            `Σήμερα εργάζομαι ως <strong>Υπεύθυνη Ανάπτυξης</strong> στην εταιρεία <strong class="font-great-vibes text-2xl">Believe in Yourself</strong> της διατροφολόγου & NLP Coach Τόνιας Καπαρελιώτη.`,
