        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 flex-1">
          ...
          <div className="bg-cyan-500 text-white p-6 rounded-xl shadow-2xl relative overflow-hidden">
            <div className="relative z-10">
              <h3 className="mb-2">Διατροφική Συμπεριφορά</h3>
              <p>
                Αναγνωρίζουμε και δουλεύουμε μαζί τις διατροφικές συμπεριφορές που σε μπλοκάρουν και σε κρατούν  μακριά από τους στόχους σου.
              </p>
            </div>
          </div>
          ...
          <div className="bg-yellow-500 text-white p-6 rounded-xl shadow-2xl relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p>
                Δημιουργούμε διατροφικά πλάνα βασισμένα στη δική σου πραγματική ζωή, τις προτιμήσεις και τη ρουτίνα της ζωής σου.
              </p>
            </div>
          </div>
          ...
          <div className="bg-teal-800 text-white p-6 rounded-xl shadow-2xl relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p>
                Χτίζουμε υγιεινές συνήθειες που διαρκούν στον χρόνο — όχι δίαιτες, γνωρίζοντας από πρώτο χέρι τι σημαίνει να στερείσαι!
              </p>
            </div>
          </div>
        </div>
