    ...
    <section className="px-4 py-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          ...
          {ctaText && ctaHref && (
            <Link href={ctaHref} className="btn self-start sm:self-auto">
              {ctaText}
            </Link>
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-4">
          {images.map((img, idx) => (
            <div
              key={idx}
              className="overflow-hidden ring-1 ring-[#E6DDD3] bg-white
                 rounded-none sm:rounded-2xl w-screen relative left-1/2 right-1/2 -ml-[50vw]
                 md:w-auto md:relative md:left-0 md:right-0 md:ml-0"
            >
              <img
                src={img.src}
